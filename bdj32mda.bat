...
set CFLAGS=%CFLAGS% -DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=205 -DFLAT_SKY_COLOR=177 -DWAD_FILE=\"DOOM2T.WAD\" -DVIEWWINDOWWIDTH=80 -DVIEWWINDOWHEIGHT=25 -DMAPWIDTH=80 -DNR_OF_COLORS=1 -DC_ONLY
...
@set GLOBOBJS=%GLOBOBJS% f_libt.c
...
@set GLOBOBJS=%GLOBOBJS% i_vmda.c
@set GLOBOBJS=%GLOBOBJS% info.c
@set GLOBOBJS=%GLOBOBJS% m_cheat.c
@set GLOBOBJS=%GLOBOBJS% m_text.c
...
@set GLOBOBJS=%GLOBOBJS% st_text.c
@set GLOBOBJS=%GLOBOBJS% tables.c
@set GLOBOBJS=%GLOBOBJS% w_wad.c
@set GLOBOBJS=%GLOBOBJS% wi_libt.c
@set GLOBOBJS=%GLOBOBJS% wi_stuff.c
@set GLOBOBJS=%GLOBOBJS% z_bmallo.c
@set GLOBOBJS=%GLOBOBJS% z_zone.c

gcc %GLOBOBJS% %CFLAGS% -o DJ/D386MDA.EXE
strip -s DJ/D386MDA.EXE
stubedit DJ/D386MDA.EXE dpmi=CWSDPR0.EXE
