...
set CFLAGS=%CFLAGS% -DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=32 -DFLAT_SKY_COLOR=7 -DWAD_FILE=\"DOOM16DT.WAD\" -DVIEWWINDOWWIDTH=80 -DVIEWWINDOWHEIGHT=50 -DMAPWIDTH=80 -DNR_OF_COLORS=16 -DC_ONLY
