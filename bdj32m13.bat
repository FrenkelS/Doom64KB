...
set CFLAGS=%CFLAGS% -DFLAT_SPAN -DFLAT_WALL -DWAD_FILE=\"DOOM64KL.WAD\" -DVIEWWINDOWWIDTH=240 -DINSTRUMENTED -DC_ONLY
...
gcc %GLOBOBJS% %CFLAGS% -o DJ/D386M13H.EXE
strip -s DJ/D386M13H.EXE
stubedit DJ/D386M13H.EXE dpmi=CWSDPR0.EXE
