...
set CFLAGS=%CFLAGS% -DFLAT_SPAN -DWAD_FILE=\"DOOM64KL.WAD\" -DC_ONLY
...
gcc %GLOBOBJS% %CFLAGS% -o DJ/DUMMY.EXE
strip -s DJ/DUMMY.EXE
stubedit DJ/DUMMY.EXE dpmi=CWSDPR0.EXE
