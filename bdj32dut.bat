...
set CFLAGS=%CFLAGS% -DFLAT_SPAN -DWAD_FILE=\"DOOM64TL.WAD\" -DC_ONLY
...
@set GLOBOBJS=%GLOBOBJS% i_dummy.c
@set GLOBOBJS=%GLOBOBJS% i_dummyt.c
...
gcc %GLOBOBJS% %CFLAGS% -o DJ/DUMMYT.EXE
strip -s DJ/DUMMYT.EXE
stubedit DJ/DUMMYT.EXE dpmi=CWSDPR0.EXE
